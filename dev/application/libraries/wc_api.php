...
class Wc_api {
   ...
   * API base endpoint
   */
  private $_api_endpoint = 'wc-api/v3/';
  /**
   * The API URL
   * @var string
   */
  ...
  public function __construct($params) {
    //$consumer_key, $consumer_secret, $store_url, $is_ssl = false 
    if ( ! empty( $params['consumer_key'] ) && ! empty( $params['consumer_secret'] ) && ! empty( $params['store_url'] ) ) {
      $this->set_api_endpoint( $params['api_endpoint'] );
      $this->_api_url = (  rtrim($params['store_url'],'/' ) . '/' ) . $this->_api_endpoint;
      $this->set_consumer_key( $params['consumer_key'] );
      $this->set_consumer_secret( $params['consumer_secret'] );
      $this->set_is_ssl( isset($params['is_ssl']) ? TRUE : FALSE );
    } else if ( ! isset( $params['consumer_key'] ) && ! isset( $params['consumer_secret'] ) ) {
  ...
  public function get_tags( $params = array() ) {
    return $this->_make_api_call( 'products/tags', $params );
  }   
   ...
   * @return mixed|json string
   */
  public function get_attributes( $params = array() ) {
    return $this->_make_api_call( 'products/attributes', $params );
  }   
