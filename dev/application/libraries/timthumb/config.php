...
if(! defined('FILE_CACHE_SUFFIX') )     define ('FILE_CACHE_SUFFIX', '.depo');      // What to put at the end of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_PREFIX') )     define ('FILE_CACHE_PREFIX', 'deposepatu');       // What to put at the beg of all files in the cache directory so we can identify them
