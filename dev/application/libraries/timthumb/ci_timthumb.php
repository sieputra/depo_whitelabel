...
define('FILE_CACHE_DIRECTORY',FCPATH . 'assets/thumbs'); 
define ('VERSION', '2.8.11');                          
if( file_exists(APPPATH. 'libraries/timthumb/config.php')) require_once(APPPATH. 'libraries/timthumb/config.php');
