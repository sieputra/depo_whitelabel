...
<html class="no-js" lang="en">
  <head>
	...
	<link rel="stylesheet" href="js/simple-lightbox/simplelightbox.min.css" />
    ...
    <div class="title-bar" data-responsive-toggle="widemenu" data-hide-for="medium" >
      <div class="title-bar-left">
        ...
        <span class="title-bar-title">
			<a href="index.php"><img class="" src="images/logo.png" style="height:20px;width:auto;"></a>
		</span>
      </div>
    ...
    <div id="widemenu" class="top-bar" >
      <div class="top-bar-left">
        <ul class="dropdown menu" data-dropdown-menu>
		  ...
		  <img class="" src="images/logo.png" style="height:25px;width:auto;">
		  </a></li>
          <li >
...
<li>DUMMY</li>          
      ...
      <div class="top-bar-right">
        <ul class="menu sosmed">
          <li><a href="#" class="facebook" ><i class="fa fa-facebook-official fa-3x"></i></a></li>
          <li><a href="#" class="twitter"><i class="fa fa-twitter-square fa-3x"></i></a></li>
		  <li><a href="#" class="instagram"><i class="fa fa-instagram fa-3x"></i></a></li>
        </ul>
      </div>
    </div>
	 </header>
